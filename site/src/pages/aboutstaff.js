                ...
                <div class="container container-background">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row staffcontent">
                                <div class="col-md-3">
                                    <img src="images/about_staff/SteveDavis.png" alt="Steve Davis Image" class="img-fluid simg mb-3 mt-3" />
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="row staffcontent">
                                <div class="col-md-3">
                                    <img src="images/about_staff/AshleyKang.jpg" alt="Ashley Kang Image" class="img-fluid simg mb-3 mt-3" />
                                </div>
                                <div class="col-md-9 stf-text mt-3">
                    ...
                    <div class="row mb-5">
                        <div class="col-md-6">
                            <div class="row staffcontent">
                                <div class="col-md-3">
                                    <img src="images/about_staff/CharlesPierce-El.jpg" alt="Charles Pierce-El Image" class="img-fluid simg mb-3 mt-3" />
                                </div>
                                <div class="col-md-9 stf-text mt-3">
